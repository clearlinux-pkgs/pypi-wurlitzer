...
%prep
%setup -q -n wurlitzer-2.0.0
cd %{_builddir}/wurlitzer-2.0.0
...
cp %{_builddir}/wurlitzer-2.0.0/LICENSE %{buildroot}/usr/share/package-licenses/wurlitzer/360b2fe584a00d26d9643bf330bf0d36a49257b8
