...
Source0  : https://files.pythonhosted.org/packages/7b/4a/8fdefccb188c37992d8c7c5922b89aaa6cbf7d738a8798f92109ed7d4212/wurlitzer-3.1.0.tar.gz
...
%prep
%setup -q -n wurlitzer-3.1.0
cd %{_builddir}/wurlitzer-3.1.0
pushd ..
cp -a wurlitzer-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714403977
